...
def gmail_send_message():
    ...
    try:
        ...
        message['Subject'] = '📍 test maill(1) '+str(datetoday)
...
def gmail_send_message1():
    ...
    try:
        ...
        message['From'] = '"SKC, Dashboard"<skc_g.dashboard@kubota.com>'
        datetoday = datetime.now()
        message['Subject'] = '📍 test maill(2) '+str(datetoday)
...
def gmail_send_message2():
    ...
    try:
        ...
        message['From'] = '"SKC, Dashboard"<skc_g.dashboard@kubota.com>'
        datetoday = datetime.now()
        message['Subject'] = '📍 test maill(3) '+str(datetoday)
...
def gmail_send_message3():
    ...
    try:
        ...
        message['From'] = '"SKC, Dashboard"<skc_g.dashboard@kubota.com>'
        datetoday = datetime.now()
        message['Subject'] = '📍 test maill(4) '+str(datetoday)
...
def gmail_send_message4():
    ...
    try:
        ...
        message['From'] = '"SKC, Dashboard"<skc_g.dashboard@kubota.com>'
        datetoday = datetime.now()
        message['Subject'] = '📍 test maill(5) '+str(datetoday)
