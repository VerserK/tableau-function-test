...
def gmail_send_message(em):
    ...
    <p style="margin-left:40px">เนื่องจากระบบพบว่าท่านไม่มีการเข้าใช้งาน Tableau เป็นเวลา 38 วัน*</p>
...
def run():
    ...
    diff83 = datetime.now() - timedelta(days=38)
    ...
    a = a.query('''position_ID.notnull() and siteRole != 'Unlicensed' and position_ID != 'Div_Mgr' and position_ID != 'Dep_Mgr' and position_ID != 'VP_GM' and position_ID != 'President' and position_ID != 'Ass_Mgr' and position_ID != 'SEVP' and position_ID != 'VP_Dep' ''')
