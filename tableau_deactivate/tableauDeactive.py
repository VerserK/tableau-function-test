...
def gmail_send_message(emailViewtoUnlicense):
    ...
    <p style="margin-left:40px">เนื่องจากระบบพบว่าท่านไม่มีการเข้าใช้งาน Tableau เป็นเวลา 90 วัน</p>
...
def run():
    ...
    a = a.query('''position_ID.notnull() and siteRole != 'Unlicensed' and position_ID != 'Div_Mgr' 
        and position_ID != 'Dep_Mgr' and position_ID != 'VP_GM' and position_ID != 'President' 
        and position_ID != 'Ass_Mgr' and position_ID != 'SEVP' 
        and position_ID != 'VP_Dep'
        and eid.str.len() != 4 ''')
